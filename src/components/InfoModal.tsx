  ...
  return (
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-content" onClick={e => e.stopPropagation()}>
        ...
        <h2>How to Use the Doherty Dining Plan</h2>
        <p><b>What is the Doherty Dining Plan?</b><br/>
        The Doherty Dining Plan is a prepaid meal package available to guests staying at Disney Resort hotels with a vacation package. It allows you to pay for meals and snacks in advance and redeem credits at participating locations throughout Walt Disney World.
        </p>
        ...
        <ul>
          ...
          <li>Snacks include items like ice cream, popcorn, bottled drinks, fries, bakery treats, and more. Look for the Doherty Dining Plan snack icon on menus.</li>
        ...
        <p style={{fontSize: '0.95em', color: '#666'}}>For more details, visit <a href="https://allears.net/walt-disney-worlds-disney-dining-plan/" target="_blank" rel="noopener noreferrer">AllEars Dining Plan Guide</a>.</p>
      </div>
    </div>
  );
};
